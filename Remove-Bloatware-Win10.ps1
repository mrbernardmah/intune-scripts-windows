...
foreach ($App in $AppArrayList) {
    ...
    if (($App.Name -in "Microsoft.WindowsCalculator", "Microsoft.WindowsSoundRecorder", "Microsoft.StorePurchaseApp", "Microsoft.Windows.Photos", "Microsoft.WindowsAlarms", "Microsoft.ScreenSketch", "Microsoft.WindowsStore", "Microsoft.MSPaint", "Microsoft.MicrosoftStickyNotes", "Microsoft.WindowsCamera", "Microsoft.HEIFImageExtension", "Microsoft.VP9VideoExtensions", "Microsoft.WebMediaExtensions", "Microsoft.WebpImageExtension")) {
